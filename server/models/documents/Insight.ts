...
const InsightsSchema = new Schema<Insight>(
  {
 ...
 * Pre middleware
 */
InsightsSchema.pre('remove', async function() {
  try {
    ...
    const insight = this.toJSON() as Insight
...
export const InsightDB = model<Insight & InsightModel>(
  'Insight',
  InsightsSchema,
)
